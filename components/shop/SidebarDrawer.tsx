  ...
  ({children, className, onOpenChange, isOpen, classNames = {}, ...props}, ref) => (
    <>
      <Modal
        ...
        classNames={{
          ...classNames,
          wrapper: cn("!items-start !justify-start max-w-full", classNames?.wrapper),
      ...
      <div
        className={cn(
          "relative hidden h-screen  w-0 max-w-[375px] flex-1 flex-col bg-gradient-to-b from-default-100 via-danger-100 to-secondary-100 p-6 transition-[transform,opacity,margin] duration-250 ease-in-out lg:flex lg:w-72",
        )}
      >
        {children}
      </div>
